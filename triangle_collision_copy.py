...
class Circle():
    def __init__(self, cx, cy, r, screen, colour):
        ...
        for phi in range(-16, 16, 1):
            phi *= math.pi / 32
            corner = (self.centerx + self.r * math.cos(phi), self.centery + self.r * math.sin(phi))
    ...
    def draw_circle(self):
        pygame.draw.circle(self.screen, self.colour, (self.centerx ,self.centery), self.r)
...
def find_collision(triangle, circle):
    ...
    #print('sum of areas between circle = ', list_of_sum_of_areas)
...
triangle5 = Triangle(200, 500, 500, 150, 500, 500, tri_colour, screen)
...
circle = Circle(200, 50, 100, screen, ball_colour)
